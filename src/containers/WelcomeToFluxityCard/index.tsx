  ...
  return (
    <div className="w-full h-[267px]">
      <CCard
        ...
        borderColor="#9af3ff"
      >
        <div className="p-[53px] mobile:p-0 mobile:flex mobile:flex-col mobile:justify-center mobile:items-start mobile:pl-6 text-midnightBlue z-20">
          <h1 className="text-[30px] w-[32%] mobile:w-[200px] font-medium">Welcome to Fluxity!</h1>
          <p className="text-[14px] w-[80%] mt-[23px] mobile:mt-3">
