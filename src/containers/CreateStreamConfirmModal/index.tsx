    ...
    <div>
      <CModal title="" isOpen={isOpen} setIsOpen={setIsOpen} width="396px">
        <div className="w-full flex flex-col items-center justify-center">
          ...
          <h1 className="text-[24px] font-normal mt-[24px] tracking-wide text-center">
            ...
            <ul className="grid gap-2 text-midnightBlue">
              <li className="flex justify-between w-full whitespace-nowrap overflow-hidden text-clip items-center bg-alabaster h-10 px-4 text-sm rounded-[10px]">
                ...
                <div className="flex">
                  {hashIcon && (
                    <Image
                      src={require(`/public/images/assets/${hashIcon}`)}
                      alt="logo"
                      width={20}
                      height={20}
                      className="mr-2"
          ...
          >
            ...
            {amount && (
              <p className="font-bold w-[80%] text-clip overflow-hidden text-right">{amount} XLM</p>
            )}
          </CCard>
          <CButton
            type="submit"
