...
const ClaimTokens = () => {
  ...
  return (
    <CCard
      ...
      className="relative bg-white p-[19.6px] short:h-[215px] h-[238px] mobile:h-[208px] w-1/2 mobile:w-full"
    >
      ...
      <div className="absolute mobile:bottom-[18px] bottom-[22px] left-[24.47px]">
        <CButton
          onClick={handleClick}
